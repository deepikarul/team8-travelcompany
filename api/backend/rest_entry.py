...
from blueprints.flights_ import flights
from blueprints.travel_agents_ import agents
from blueprints.travel_packages_ import packages
...
def create_app():
    ...
    app.register_blueprint(packages,   url_prefix='/p')
